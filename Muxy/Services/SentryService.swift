...
final class SentryService {
    ...
    private static func resolveBundledDSN() -> String? {
        // Muxy fork: telemetry removed. Always return nil so `hasDSN` is false →
        // the Sentry SDK never initializes and the consent prompt never appears,
        // regardless of any build-time DSN injection or local .env.
        return nil
    }
